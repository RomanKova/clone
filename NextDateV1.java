 ...
 * of week 2 of EECS4313- Group A 
 */
public class NextDateV1 {
    public static SimpleDateV1 nextDate(SimpleDateV1 date) {
           ...
           SimpleDateV1 sd = new SimpleDateV1(); 
           sd.setDay(tomorrowDay);
           sd.setMonth(tomorrowMonth);
           sd.setYear(tomorrowYear);
            return sd; 
    }
}
...
class SimpleDateV1 {
    ...
    public SimpleDateV1(int month, int day, int year) {
  ...
  */
    ...
    public boolean equals(Object obj) {
                 ...
                 if(obj instanceof SimpleDateV1) {
                       SimpleDateV1 simpleDate = (SimpleDateV1) obj;
